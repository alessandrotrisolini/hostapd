...
struct wpa_driver_ops {
	 ...
	 * Returns: 0 on success, -1 on failure (or if not supported)
	 */
	int (*create_receive_sc)(void *priv, struct receive_sc *sc, const u8 *sci_addr,
				 u16 sci_port, enum confidentiality_offset conf_offset,
				 int validation);
...
extern const struct wpa_driver_ops wpa_driver_macsec_linux_ops; /* driver_macsec_linux.c */
