 ...
 * @macsec_desired: the participant wants MACsec to be used to protect frames (9.6.1)
 * @key_server: the participant has not decided that another participant is or will be the key server (9.5.1)
...
/**
 * struct ieee802_1x_mka_sak_use_body - MACsec SAK Use parameter set (Figure 11-10)
 ...
 * @delay_protect: True if LPNs are being reported sufficiently
		   frequently to allow the recipient to provide data
		   delay protection.
		   If False, the LPN can be reported as zero.
...
/**
 * struct ieee802_1x_mka_dist_sak_body - Distributed SAK parameter set (GCM-AES-128, Figure 11-11)
...
/**
 * struct ieee802_1x_mka_dist_cak_body - Distributed CAK parameter set (Figure 11-13)
