...
{
	return wpa_drv_create_receive_sc(wpa_s, sc, sci->addr,
...
static const struct ieee802_1x_kay_ctx kay_ops = {
	...
	.macsec_get_capability		= wpas_macsec_get_capability,
	.enable_protect_frames		= wpas_enable_protect_frames,
	.enable_encrypt			= wpas_enable_encrypt,
	...
	.delete_receive_sa		= wpas_delete_receive_sa,
	...
	.delete_transmit_sa		= wpas_delete_transmit_sa,
				      ...
				      const u8 *peer_addr)
{
	...
	wpa_hexdump(MSG_ERROR, "Session Id", sid, sid_len);
